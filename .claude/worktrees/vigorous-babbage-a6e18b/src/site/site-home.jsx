...
export function SiteHome() {
  ...
  return (
    <>
      ...
      ════════════════════════════════════════════════ */}
      <section className="site-section site-section--dark" id="live-results" style={{ background: "#0a0a0a" }}>
        <div className="site-container">
          <div className="site-section-header site-section-header--center" style={{ marginBottom: 40 }}>
            <span className="site-eyebrow" style={{ color: "#ef4444", letterSpacing: "0.15em", fontWeight: 700 }}>
              ● LIVE
            </span>
            <h2 className="site-heading" style={{ color: "#fff" }}>
              {latestEdition?.streamingUrl && latestEdition?.liveResultsUrl
                ? "Watch Live & Follow Results"
                : latestEdition?.streamingUrl
                  ? "Watch Live"
                  : "Results & Live Ranking"}
            </h2>
            <p className="site-lead" style={{ color: "rgba(255,255,255,0.65)" }}>
              {latestEdition?.streamingUrl && latestEdition?.liveResultsUrl
                ? "The meeting is live — stream the event and follow results in real time."
                : latestEdition?.streamingUrl
                  ? "The meeting is streaming live — watch it directly here."
          ...
          {latestEdition?.streamingUrl && (
            <div style={{
              ...
              maxWidth: 960,
              margin: "0 auto",
              marginBottom: latestEdition?.liveResultsUrl ? 40 : 0,
            }}>
              <iframe
          ...
          {/* Live results (laportal) */}
          {latestEdition?.liveResultsUrl && (
            <>
              {latestEdition?.streamingUrl && (
                <div style={{ textAlign: "center", marginBottom: 16 }}>
                  <span style={{ fontSize: "0.85rem", color: "rgba(255,255,255,0.5)", letterSpacing: "0.1em", textTransform: "uppercase", fontWeight: 600 }}>
                    Live Results
                  </span>
                </div>
              )}
              <div style={{
                ...
                <iframe
                  src={latestEdition.liveResultsUrl}
              ...
              <div style={{ textAlign: "center", marginTop: 20 }}>
                <a
                  href={latestEdition.liveResultsUrl}
                  target="_blank"
